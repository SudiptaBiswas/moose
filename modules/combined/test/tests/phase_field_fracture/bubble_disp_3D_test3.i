...
[MultiApps]
  [damage]
    ...
    input_files = 'bubble_c_3D_test2.i'
  []
[]
  ...
  [./TensorMechanics]
    [./Master]
      ...
      [./mech]
        add_variables = true
        strain = SMALL
        additional_generate_output = 'stress_yy stress_xy stress_xx stress_zz stress_xz stress_yz strain_xx strain_xy strain_yy strain_zz strain_xz strain_yz hydrostatic_stress mid_principal_stress min_principal_stress max_principal_stress'
