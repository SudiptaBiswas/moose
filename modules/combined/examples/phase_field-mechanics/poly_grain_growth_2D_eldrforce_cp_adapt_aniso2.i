...
[MultiApps]
  [sub_app]
    ...
    # positions = '0 0 0'
    input_files = 'Cu_uniaxial_64G_test_coupling_test.i'
...
[Materials]
  ...
  [CuGrGr]
    ...
    GBenergy = GBEnergy #J/m^2 from schonfelder1997molecular bibtex entry
    outputs = exodus
  []
  [./GB_type]
