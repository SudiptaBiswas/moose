...
[Materials]
  [./bulk_en]
    ...
    function = 'm:=0.9 * atan(20 * (1 - T)) / pi; 1/4*w^4 - (1/2 - m/3) * w^3 + (1/4 - m/2) * w^2'
    # outputs = exodus
  [../]
  [./consts]
    type = GenericConstantMaterial
    prop_names  = 'L     kappa_op kappa_theta L_eta'
    prop_values = '33.32 0.0223      0.1     0.9'
  [../]
  [./int_coeff]
    type = DerivativeParsedMaterial
    f_name = int_coeff
...
[Outputs]
  exodus = true
  file_base = 2018_07_25_poly_dendrite_kwc_test
[]
