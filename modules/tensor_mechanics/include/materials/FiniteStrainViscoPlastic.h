 ...
 */
class FiniteStrainViscoPlastic : public ComputeStressBase
{
public:
...
protected:
  ...
  /// Number of internal variable tensor rate user objects
  unsigned int _num_int_var_rate_tensor_uos;
  /// Number of internal variable tensor user objects
