...
/**
 * ADGeneralizedRadialReturnStressUpdateBackup computes the generalized radial return stress
 * increment for anisotropic (Hill-like) creep and plasticity. This generalized radial return
 * mapping class acts as a base class for the radial return of anisotropic creep and plasticity
 * classes/combinations. The stress increment computed by
 * ADGeneralizedRadialReturnStressUpdateBackup is used by ComputeMultipleInelasticStress which
 * computes the elastic stress for finite strains. This class is based on the algorithm in Versino,
 * D, Bennett, KC. Generalized radial return mapping algorithm for anisotropic von Mises plasticity
 * framed in material eigenspace. Int J Numer Methods Eng. 2018. 116. 202 222
 */

class ADGeneralizedRadialReturnStressUpdateBackup : public ADStressUpdateBase,
                                                    public ADGeneralizedReturnMappingSolution
{
public:
  static InputParameters validParams();

  ADGeneralizedRadialReturnStressUpdateBackup(const InputParameters & parameters);
