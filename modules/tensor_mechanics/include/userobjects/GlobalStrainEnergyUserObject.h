...
#ifndef GLOBALSTRAINENERGYUSEROBJECT_H
#define GLOBALSTRAINENERGYUSEROBJECT_H
...
class GlobalStrainEnergyUserObject;

template <>
InputParameters validParams<GlobalStrainEnergyUserObject>();

class GlobalStrainEnergyUserObject : public ElementUserObject,
                                     public GlobalStrainUserObjectInterface
{
public:
  GlobalStrainEnergyUserObject(const InputParameters & parameters);
...
#endif // GLOBALSTRAINENERGYUSEROBJECT_H
