...
#include "InterfaceOrientationMultiphaseMaterial2.h"
#include "MooseMesh.h"
#include "MathUtils.h"

registerMooseObject("PhaseFieldApp", InterfaceOrientationMultiphaseMaterial2);

template <>
InputParameters
validParams<InterfaceOrientationMultiphaseMaterial2>()
{
...
InterfaceOrientationMultiphaseMaterial2::InterfaceOrientationMultiphaseMaterial2(
    ...
    _d2kappadgradetaadetab(_op_num)
{
  ...
  if (_mesh.dimension() != 2)
    mooseError("InterfaceOrientationMultiphaseMaterial2 requires a two-dimensional mesh.");
...
void
InterfaceOrientationMultiphaseMaterial2::computeQpProperties()
{
