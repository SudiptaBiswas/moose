...
/****************************************************************/
#include "ViscoPlasticEnergyMaterial.h"
#include "RankTwoTensor.h"
#include "RankFourTensor.h"

template<>
InputParameters validParams<ViscoPlasticEnergyMaterial>()
{
...
ViscoPlasticEnergyMaterial::ViscoPlasticEnergyMaterial(const InputParameters & parameters) :
...
Real
ViscoPlasticEnergyMaterial::computeF()
{
...
Real
ViscoPlasticEnergyMaterial::computeDF(unsigned int i_var)
{
...
Real
ViscoPlasticEnergyMaterial::computeD2F(unsigned int i_var, unsigned int j_var)
{
  unsigned int i = argIndex(i_var);
...
void
ViscoPlasticEnergyMaterial::computeDerivatives()
{
