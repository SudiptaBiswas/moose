...
registerMooseObject("MooseApp", RosenthalPolycrystalICOld);

InputParameters
RosenthalPolycrystalICOld::validParams()
{
  ...
  params.addRequiredParam<UserObjectName>(
      "rosenthal_temperature_uo",
      "UserObject holding information about the rosenthal temperature profile");
...
RosenthalPolycrystalICOld::RosenthalPolycrystalICOld(const InputParameters & parameters)
...
Real
RosenthalPolycrystalICOld::value(const Point & p)
{
  Real value = 0;
