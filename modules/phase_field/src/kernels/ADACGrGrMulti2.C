...
#include "ADACGrGrMulti2.h"

registerMooseObject("PhaseFieldApp", ADACGrGrMulti2);

InputParameters
ADACGrGrMulti2::validParams()
{
...
ADACGrGrMulti2::ADACGrGrMulti2(const InputParameters & parameters)
