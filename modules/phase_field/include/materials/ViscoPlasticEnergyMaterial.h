...
/****************************************************************/
#ifndef VISCOPLASTICENERGYMATERIAL_H
#define VISCOPLASTICENERGYMATERIAL_H
...
// Forward Declaration
class ViscoPlasticEnergyMaterial;
class RankTwoTensor;
 ...
 */
class ViscoPlasticEnergyMaterial : public DerivativeFunctionMaterialBase
{
public:
  ViscoPlasticEnergyMaterial(const InputParameters & parameters);
...
#endif //VISCOPLASTICENERGYMATERIAL_H
