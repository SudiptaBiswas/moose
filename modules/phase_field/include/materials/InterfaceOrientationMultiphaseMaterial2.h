...
class InterfaceOrientationMultiphaseMaterial2;

template <>
InputParameters validParams<InterfaceOrientationMultiphaseMaterial2>();

/**
 * Material to compute the angular orientation of order parameter interfaces.
 */
class InterfaceOrientationMultiphaseMaterial2 : public DerivativeMaterialInterface<Material>
{
public:
  InterfaceOrientationMultiphaseMaterial2(const InputParameters & parameters);
