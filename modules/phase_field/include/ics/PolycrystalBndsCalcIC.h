...
class PolycrystalBndsCalcIC;
class GrainTrackerInterface;
class PolycrystalUserObjectBase;

template <>
InputParameters validParams<PolycrystalBndsCalcIC>();

/**
 * PolycrystalBndsCalcIC creates a polycrystal initial condition.
 ...
 */
class PolycrystalBndsCalcIC : public InitialCondition
{
public:
  PolycrystalBndsCalcIC(const InputParameters & parameters);
