...
#ifndef POLYCRYSTALWELDINGIC_H
#define POLYCRYSTALWELDINGIC_H
...
class PolycrystalWeldingIC;

template <>
InputParameters validParams<PolycrystalWeldingIC>();

/**
 * PolycrystalWeldingIC initializes either grain or void values for a
 * voronoi tesselation with voids distributed along the grain boundaries.
 */
class PolycrystalWeldingIC : public MultiSmoothCircleIC
{
public:
  PolycrystalWeldingIC(const InputParameters & parameters);
