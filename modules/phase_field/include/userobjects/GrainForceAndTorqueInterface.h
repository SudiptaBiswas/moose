...
public:
  ...
  virtual const std::vector<std::vector<RealGradient> > & getForceDerivativesJacobian() const = 0;
  virtual const std::vector<std::vector<RealGradient> > & getTorqueDerivativesJacobian() const = 0;
