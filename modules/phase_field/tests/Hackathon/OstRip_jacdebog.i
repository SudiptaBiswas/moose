...
[Functions]
  [./ic_c_func]
    type = ParsedFunction
    value = '0.45+0.01*cos(sqrt(2.0)*x+sqrt(3.0)*y)'
  [../]
  [./ic_eta0]
    type = ParsedFunction
    value = '0.01*0.979285*cos(sqrt(23.0)*x+sqrt(149.0)*y)*(sqrt(23.0)*x+sqrt(149.0)*y)'
  [../]
  [./ic_eta1]
    type = ParsedFunction
    value = '0.01*0.219812*cos(sqrt(24.0)*x+sqrt(150.0)*y)*(sqrt(24.0)*x+sqrt(150.0)*y)'
  [../]
[]
