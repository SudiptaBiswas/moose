...
[Materials]
  ...
  [./int]
    ...
    constant_expressions = '0.1 1/2/sqrt(2)'
  ...
  [../]
  [./kappaa]
    type = InterfaceOrientationMultiphaseMaterial3
    kappa_name = kappaa
    dkappadgrad_etaa_name = dkappadgrad_etaa
    d2kappadgrad_etaa_name = d2kappadgrad_etaa
    etaa = etaa0
    ...
    kappa_bar = 0.1
    outputs = exodus
    output_properties = 'kappaa kappaa_normal'
  [../]
  [./kappaa1]
    type = InterfaceOrientationMultiphaseMaterial3
    kappa_name = kappaa1
    ...
    reference_angle = 0
    outputs = exodus
    output_properties = 'kappaa1 kappaa1_normal'
  [../]
  [./kappab]
    type = InterfaceOrientationMultiphaseMaterial3
    kappa_name = kappab
    ...
    kappa_bar = 0.1
    outputs = exodus
    output_properties = 'kappab kappab_normal'
  [../]

  [./const]
    type = GenericConstantMaterial
    prop_names =  'L     D  chi  Vm   ka    caeq kb    cbeq  gab mu   S   Tm   kappa'
    prop_values = '333.33 1  0.1  1.0  10.0  0.1  10.0  0.9   4.5 10.0 1.0 1.0  0.1'
  [../]
  # [./D]
  #   type = DerivativeParsedMaterial
  #   args = 'w '
...
[./Markers]
   ...
   [./combo]
     type = ComboMarker
     markers = 'err_bnds err_w err_eta err_eta0 err_eta1'
   [../]
 [../]
 [./Indicators]
   [./ind_w]
...
[Outputs]
  # interval = 5
  exodus = true
  file_base = 2020_02_20_GrandPotentialSolidification_multi_test3
[]
