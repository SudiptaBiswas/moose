...
[ICs]
  ...
  [./etab0]
    ...
    variable = etab0
    #Liquid phase
    x_positions = '-40 40 -40 40'
    y_positions = '-40 -40 40 40'
    z_positions = '0 0 0 0'
...
#Chemical potential
  ...
  [./coupled_etaa1dot_int]
    ...
    f_name = rhodiff
  [../]
  [./coupled_etab2dot_int]
    type = ADAntitrappingCurrent
    variable = w
    v = etaa2
    f_name = rhodiff
  [../]
  [./coupled_etaa3dot_int]
    type = ADAntitrappingCurrent
    variable = w
    v = etaa3
    f_name = rhodiff
...
[Materials]
  ...
  [./const]
    ...
    prop_values = '333.33 1.0  0.1  1.0  10.0  0.1  10.0  0.9   1.5 10.0 1.0 1.0'
  [../]
  [./Mobility]
