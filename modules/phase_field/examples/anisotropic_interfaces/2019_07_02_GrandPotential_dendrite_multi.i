...
# Order parameter eta_beta0
  ...
  [./ACb0_int1]
    ...
    etas = 'etaa0 etab1'
    kappa_name = kappab0
    dkappadgrad_etaa_name = dkappadgrad_etab0
    d2kappadgrad_etaa_name = d2kappadgrad_etab0
  [../]
  [./ACb0_int2]
    type = ACInterface2DMultiPhase2
    variable = etab0
  ...
  # Order parameter eta_beta1
    ...
    [./ACb1_int1]
      ...
      etas = 'etaa0 etab0'
      kappa_name = kappab1
      dkappadgrad_etaa_name = dkappadgrad_etab1
      d2kappadgrad_etaa_name = d2kappadgrad_etab1
    [../]
    [./ACb1_int2]
      type = ACInterface2DMultiPhase2
      variable = etab1
...
[Materials]
  ...
  [./kappab1]
    ...
    anisotropy_strength = 0.05
    outputs = exodus
    output_properties = 'kappab1'
  [../]
  [./const]
    type = GenericConstantMaterial
    prop_names =  'L    D   Vm        kB       gab   mu    fsni        Ea  T   kappa'
    prop_values = '10.0 0.1 1.232e-8 1.38e-10   1.5  0.0853  -0.245  5.82e-8 1710 0.0287'
  [../]
  [./Mobility]
    type = DerivativeParsedMaterial
    f_name = Dchi
