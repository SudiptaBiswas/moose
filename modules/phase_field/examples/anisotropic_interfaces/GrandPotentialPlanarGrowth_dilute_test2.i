...
[Materials]
  ...
  [./omegaa]
    ...
    function = '-ka*T/Vm*exp((w-Ea)/ka/T)'
  [../]
  [./omegab]
    type = DerivativeParsedMaterial
    args = 'w T'
  ...
  [./cs]
    ...
    args = 'w T'
    f_name = ca
    material_property_names = 'Vm ka caeq Ea'
    # function = 'w/Vm/ka+caeq'
    function = 'exp((w-Ea)/ka/T)'
  ...
  [./chi]
    ...
    # material_property_names = 'Vm ka cbeq'
    # function = 'w/Vm/ka+cbeq'
    material_property_names = 'c Vm ka'
    function = 'c/Vm/ka/T'
  ...
  [./const]
    ...
    prop_names =  'L   Vm   ka    caeq kb    cbeq  gab mu   S   Tm  Ea'
    prop_values = '10.0 1.0  10.0  0.1  10.0  0.9   1.5 10.0 1.0 1.0 1.0'
  [../]
  [./Mobility]
    type = ParsedMaterial
    f_name = Dchi
