...
[Materials]
  ...
  [./concentration]
    type = ParsedMaterial
    f_name = c
    material_property_names = 'rhoa ha rhob hb Va'
    function = 'Va*(ha*rhoa + hb*rhob)'
    outputs = exodus
  [../]
  [./kappaa]
  ...
  [./const]
    ...
    prop_names =  'L      chi  Vm   ka    caeq kb    cbeq  gab mu   S   Tm   kappa'
    prop_values = '333.33 0.1  1.0  10.0  0.1  10.0  0.9   4.5 10.0 1.0 1.0  0.1'
  [../]
  [./D]
    type = DerivativeParsedMaterial
    args = 'w '
...
[Outputs]
  # interval = 5
  exodus = true
  file_base = 2020_02_18_GrandPotentialSolidification_multi_dfn
[]
