...
[ICs]
  [./w]
    type = BoundingBoxIC
    variable = w
    outside = -3.81e-5 #-6.58e-7
    inside = -3.63e-5 #-6.27e-7
  [../]
  [./etaa0]
    type = BoundingBoxIC
    variable = etaa0
...
[Materials]
  ...
  [./const]
    ...
    prop_values = '1.0 1.232e-5 7.99e-9 7.99e-9  1.5  0.00988  -1.42e-2  3.37e-6 1710 0.0287 0.01 1.0'
    # prop_values = '1.0 1.232e-8 1.38e-10 1.38e-10  1.5  0.171  -0.245  5.82e-8 1710 0.0287 0.1 1.0'
  [../]
  [./Mobility]
    type = DerivativeParsedMaterial
    f_name = Dchi
