...
public:
  ...
  virtual void prepareNonlocal(THREAD_ID tid) override;
  ...
  virtual void prepareBlockNonlocal(unsigned int ivar, unsigned int jvar, const std::vector<dof_id_type> & idof_indices, const std::vector<dof_id_type> & jdof_indices, THREAD_ID tid) override;
  ...
  virtual void addJacobianNonlocal(SparseMatrix<Number> & jacobian, THREAD_ID tid) override;
  ...
  virtual void addJacobianBlockNonlocal(SparseMatrix<Number> & jacobian, unsigned int ivar, unsigned int jvar, const DofMap & dof_map, std::vector<dof_id_type> & idof_indices, std::vector<dof_id_type> & jdof_indices, THREAD_ID tid) override;
  ...
  virtual void cacheJacobianNonlocal(THREAD_ID tid) override;
