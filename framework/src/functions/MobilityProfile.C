...
registerMooseObject("MooseApp", MobilityProfile);

template <>
InputParameters
validParams<MobilityProfile>()
{
  ...
  params.addRequiredParam<Real>("haz", "Width of the haz zone");
...
MobilityProfile::MobilityProfile(const InputParameters & parameters)
  : Function(parameters),
