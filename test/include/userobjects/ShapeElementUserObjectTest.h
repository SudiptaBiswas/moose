...
#ifndef SHAPEELEMENTUSEROBJECTTEST_H
#define SHAPEELEMENTUSEROBJECTTEST_H

#include "ShapeElementUserObject.h"

//Forward Declarations
class ShapeElementUserObjectTest;
...
{
public:
  ShapeElementUserObjectTest(const InputParameters & parameters);

  virtual ~ShapeElementUserObjectTest() {}
